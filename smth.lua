-- =============================================================================
-- GITHUB FORMAT: PART 1 (MAIN CONTAINER AND SIDEBAR METRICS)
-- =============================================================================
...
SidebarFrame.BackgroundColor3 = Color3.fromRGB(65, 65, 65)
...
-- =============================================================================
-- GITHUB FORMAT: PART 2 (UI DATA TEXTBOXES & FIELD INITIALIZATION)
-- =============================================================================
...
-- =============================================================================
-- GITHUB FORMAT: PART 3 (INVENTORY TRACKING DRAWER INTERFACE)
-- =============================================================================
...
-- =============================================================================
-- GITHUB FORMAT: PART 4 (GEOMETRIC COMPILATION & BLUEPRINT MATRIX)
-- =============================================================================
local hook2 = _G.BoatHub_Part2
...
btnSelect.MouseButton1Click:Connect(function()
    ...
    local rConn, cConn
    rConn = game:GetService("RunService").RenderStepped:Connect(function() selectionBox.Adornee = Mouse.Target end)
...
-- =============================================================================
-- GITHUB FORMAT: PART 5 (SERVER EXECUTION & INTEGRATED AUTO-FARM SECTOR)
-- =============================================================================
local hook1 = _G.BoatHub_Part1
local hook2 = _G.BoatHub_Part2
...
local AutoFarmPage = hook1.AutoFarmPage
...
local folder = workspace:WaitForChild("Blocks", 5):WaitForChild(game:GetService("Players").LocalPlayer.Name, 5)
...
btnBuild.MouseButton1Click:Connect(function()
    ...
    local function getRF(n)
        local tl = game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(n) or (game:GetService("Players").LocalPlayer.Character and game:GetService("Players").LocalPlayer.Character:FindFirstChild(n))
...
local function runFarmCycle()
    ...
    for i = 1, 10 do
        ...
        if targetPart then
            ...
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = targetPart.CFrame
        end
        task.wait(1.5)
    end
    ...
    if toggled and isCharacterReady() then
        ...
        if chestTrigger then
            ...
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = chestTrigger.CFrame
        end
        task.wait(4)
        removePlatform()
...
game:GetService("Players").LocalPlayer.CharacterRemoving:Connect(removePlatform)
